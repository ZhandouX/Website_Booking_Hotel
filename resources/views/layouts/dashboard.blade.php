    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                <a class="navbar-brand brand-logo me-5" href="index.html"><img src="/skydash/src/assets/images/logo.svg"
                        class="me-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="index.html"><img
                        src="/skydash/src/assets/images/logo-mini.svg" alt="logo" /></a>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown d-flex align-items-center">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                            ...
                            <!-- Nama Admin di samping gambar -->
                            @if (session('admin_name'))
                                <span class="ms-2 d-none d-lg-inline text-black">{{ session('admin_name') }}</span>
                            @endif
                        </a>
