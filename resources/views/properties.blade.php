...
<head>
  <meta charset="utf-8">
  <title>Booking Hotel - Daftar Hotel</title>
          ...
          <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0 text-center">
            ...
            <div class="collapse navbar-collapse justify-content-between font-lato" id="navbarCollapse">
              <div class="navbar-nav mr-auto py-0 ">
                ...
                <a href="{{ route('properties') }}" class="nav-item nav-link active">Hotel List</a>
        ...
        <div class="container text-center pb-5">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb justify-content-center text-uppercase">
              <li class="breadcrumb-item text-white active font-raleway fw-bold" aria-current="page">Daftar Hotel</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div class="container">
        <div class="owl-carousel testimonial-carousel py-5">
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Hotel Santika Premiere Ambon terletak di area / kota Sirimau. Resepsionis 24 jam
              tersedia untuk melayani Anda, dari check-in hingga check-out, atau bantuan apa pun yang Anda butuhkan.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Yuan-profil.png') }}"
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Hotel Santika Premiere menyediakan berbagai fasilitas seperti Wi-Fi Gratis,
              Restoran dalam hotel, AC di setiap kamar, serta layanan antar-jemput bandara. Tersedia juga ruang meeting
              dan kolam renang outdoor.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Diva-profil.jpeg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p>Hotel ini berada di pusat kota Ambon, dekat dengan pusat perbelanjaan, kantor pemerintahan, dan destinasi
              wisata budaya. Lokasinya sangat strategis bagi pelancong bisnis maupun liburan.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Reza-profil.jpeg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Terletak strategis di pusat kota, hotel ini menawarkan pemandangan laut yang
              menawan, fasilitas lengkap seperti restoran, ruang pertemuan, kolam renang, serta kamar-kamar elegan yang
              cocok untuk pelancong bisnis maupun wisatawan.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Vivi-profil.jpeg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Swiss-Belhotel Ambon menyediakan berbagai fasilitas seperti Wi-Fi gratis,
              restoran dalam hotel, AC di setiap kamar, serta layanan antar-jemput bandara. Tersedia juga ruang meeting
              dan kolam renang outdoor.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/gibran-profil.jpg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Hotel terbaik dengan lokasi yg stretegis terletak di tengah kota dan mudah di
              akses. pengalaman nginap saya yaitu hotel ini memiliki Kamar yg nyaman, aman dan fasilitas yang baik.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Fauzi-profil.jpg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
          ...
          <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
            <p class="text-truncate-3">Hotel ini berada di pusat kota Ambon, dekat dengan pusat perbelanjaan, kantor
              pemerintahan, dan destinasi wisata budaya. Lokasinya sangat strategis bagi pelancong bisnis maupun
              liburan.</p>
            <div class="d-flex align-items-center">
              <img class="img-fluid flex-shrink-0 rounded" src="{{ asset('images/team/Eka-profil.jpeg') }}"
                style="width: 45px; height: 45px;">
              <div class="ps-3">
