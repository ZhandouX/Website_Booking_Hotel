  ...
  <div class="container-fluid bg-light p-0">
    ...
    <div class="container-xxl py-5">
      <div class="container">
        ...
        <div class="row justify-content-center g-4"> {{-- Tengah Horizontal --}}
          <div class="col-lg-8"> {{-- Batas lebar konten --}}
          ...
          @endif
                  ...
                  <form action="{{ url('/profile/update') }}" method="POST">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-12">
                        <button class="btn btn-primary w-100 py-2" type="submit">Simpan Perubahan</button>
                      </div>
                    </div>
                  </form>
