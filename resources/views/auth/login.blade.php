...
<head>
  ...
  <title>Login - Booking Hotels</title>
...
<body>
  ...
  <div class="wrapper">
    <form method="POST" action="/login">
      ...
      <h2 class="text-white font-opensans py-2">Login</h2>
    ...
    @endif
      ...
      <button type="submit" class="button rounded-3">Login</button>

      <div class="register">
        <p>Belum punya akun? <a href="/register" class="text-primary">Daftar</a></p>
      </div>
    </form>
  </div>
