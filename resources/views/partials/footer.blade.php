        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5 col-md-12">
                <div class="row gy-5 g-4">
                    <div class="col-md-6">
                        <h6 class="section-title text-start text-primary text-uppercase mb-4">Profil Perusahaan</h6>
                        <a class="btn btn-link" href="#" data-bs-toggle="modal" data-bs-target="#popupAboutUs">
                              Tentang Kami</a>
                        <a class="btn btn-link" href="#" data-bs-toggle="modal" data-bs-target="#popupContactUs">
                            Kontak Kami</a>
                        <a class="btn btn-link" href="#" data-bs-toggle="modal"
                            data-bs-target="#popupPrivacyPolicy">Kebijakan Privasi</a>
                        <a class="btn btn-link" href="#" data-bs-toggle="modal" data-bs-target="#popupTerms">Syarat & Ketentuan 
                       </a>
                        <a class="btn btn-link" href="#" data-bs-toggle="modal"
                            data-bs-target="#popupSupport">Pendukung</a>
                    </div>
                    <div class="col-md-6">
...
<div class="modal fade" id="popupTerms" tabindex="-1" aria-labelledby="popupTermsLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header bg-dark text-white">
                <h5 class="modal-title text-light" id="popupTermsLabel"><i class="fas fa-file-contract me-2"></i>Syarat & Ketentuan
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
...
<div class="modal fade" id="popupSupport" tabindex="-1" aria-labelledby="popupSupportLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header bg-dark text-white">
                <h5 class="modal-title text-light" id="popupSupportLabel"><i class="fas fa-headset me-2"></i>Pendukung</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Tutup"></button>
            </div>
            <div class="modal-body p-4">
                <p class="mb-3">Jika Anda memiliki pertanyaan, masalah teknis, atau membutuhkan bantuan, tim Pendukung
