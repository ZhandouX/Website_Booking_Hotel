                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px;">
                        ...
                        <h1 class="display-3 text-light mb-4 animated slideInDown">Hotel Nyaman &
                            Terjangkau</h1>
                        <a href="#about" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Tentang Kami</a>
                        <a href="#daftar-hotel" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Daftar Hotel</a>
                    </div>
                </div>
            </div>
                ...
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px;">
                        ...
                        <a href="#cari" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Jelajahi
                            Hotel</a>
                        <a href="#subscribe" class="btn btn-light py-md-3 px-md-5 animated slideInRight">Berlangganan</a>
                    </div>
                </div>
            </div>
        </div>
